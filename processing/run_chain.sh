...
# Existing LHE pools on T2_CN_Beijing storage (only pools with files)
# All pools use T2 storage path - if empty, DAG will generate LHE first
declare -A EXISTING_POOLS=(
    # pool_upsilon_g has ~1000 files on T2
    ["pool_upsilon_g"]="lhe_pools/pool_upsilon_g"
    # Other pools will be generated by DAG LHE jobs
)
